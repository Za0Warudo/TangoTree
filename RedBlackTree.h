 ...
 * can be either RED or BLACK. One could use a boolean instead, but using an enum
 ...
 * blackHeight of the nil node are all set to 0. The maxDepth and minDepth are set 
 * to be the SHORT_MIN and SHORT_MAX.  This allows us to treat the nil
